...
bool getParams(int argc, char *argv[], map<string, string> &params)
{
    ...
    for (int i = 1; i < argc; i += 1)
    {
        ...
        if (str == "-h")
        {
            ...
            cout << "\t ./EMAFBIGDATA -i /path/to/input -o /path/to/output -e LM" << endl;
            cout << CYAN << "Align using Local Maximum: " << RESET << endl;
            cout << "\t ./EMAFBIGDATA -i /path/to/input -o /path/to/output -m LM -wh 6" << endl;
            cout << CYAN << "Align using Main Direction: " << RESET << endl;
            cout << "\t ./EMAFBIGDATA -i /path/to/input -o /path/to/output -m MD -wl 10" << endl;
            helpFlag = true;
            break;
        }
        else if (str == "-i")
...
/// Please see ./EMAFBIGDATA -h for input format instructions.
