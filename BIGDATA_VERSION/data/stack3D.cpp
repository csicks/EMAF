...
stackComplex::stackComplex(const long long *s)
{
    shape[0] = s[0];
    shape[1] = s[1];
    shape[2] = s[2];
...
double *stackComplex::get(long long i, long long j, long long k) const
{
    return data[i * shape[1] * shape[2] + j * shape[2] + k];
}

void stackComplex::set(long long i, long long j, long long k, const double value[2])
{
    data.set(i * shape[1] * shape[2] + j * shape[2] + k, value);
}

imageComplex stackComplex::pieceGet(long long index) const
{
...
void stackComplex::pieceSet(long long index, const imageComplex &img)
{
